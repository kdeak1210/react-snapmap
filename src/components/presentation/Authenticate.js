...
class Authenticate extends Component{
  ...
  submitCredentials(){
    ...
    this.props.onLogin(registration) // send it up to the container
  }
  ...
  render(){
    return(
      <div>
        ...
        <button onClick={this.submitRegistration.bind(this)}>Sign Up</button>          
        <button onClick={this.submitCredentials.bind(this)}>Log in</button>                  
      </div>
    )
  }
}
